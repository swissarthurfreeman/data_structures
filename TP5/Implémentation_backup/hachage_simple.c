...
int hashSimple(char mot[10]) { //Fonction de hachage simple, avec C = 3.
    return 3*codeMot(mot) % M;
}
...
int main() {
    ...
    int age, numSiege, id;
    FILE * fp;
    fp = fopen("passagers10000.txt", "r"); //On ouvre le fichier avec 10 000 passagers.
